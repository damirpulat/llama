regression <-
function(regressor=NULL, data=NULL, pre=function(x, y=NULL) { list(features=x) }, save.models=NA, use.weights = TRUE) {
    set.seed(1, "L'Ecuyer")
    ...
    retval = list(predictions=predictions, models=models)
